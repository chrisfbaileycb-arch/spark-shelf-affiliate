...
export const GUIDES: Record<string, Guide> = {
  "tiktok-shop-affiliate": {
    ...
    body: (
      <>
        <p>TikTok Shop, YouTube Shopping, and Facebook Reels pay creators a percentage of every sale they drive. The math is simple: more shots on goal, more commissions. The bottleneck is video production. This guide walks through how AI-generated influencer videos change that.</p>

        <h2>1. Pick products with real demand</h2>
        <p>Open the TikTok Creator Marketplace, Amazon Influencer dashboard, or your chosen affiliate network and filter by trending products. Sort by GMV or conversions over the last 7 days and look for items with:</p>
        <ul>
        ...
        <p>Copy the product page link directly from Amazon, AliExpress, Shopify, or any supported store. Paste it into ReelRipper. We pull the product name, price, image, and description automatically.</p>

        <h2>3. Build a persona once</h2>
        <p>Your persona is the recurring AI creator that fronts every video. Consistency builds recognition. Pick a niche (beauty, home, wellness, gadgets), a vibe (relatable, expert, hype), and let the persona generator lock in a HeyGen avatar and ElevenLabs voice. From then on every video uses the same face and voice — the way real short-form creators do it.</p>
        ...
        <p>FTC guidelines require you to disclose paid or commissioned relationships. Add #ad or use each platform's "Paid partnership" toggle on every post. ReelRipper appends two hashtags automatically — leave those in and add the disclosure hashtag yourself.</p>
