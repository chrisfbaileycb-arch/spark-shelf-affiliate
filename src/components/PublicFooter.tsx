    ...
    <footer className="border-t border-border">
      <div className="mx-auto max-w-6xl px-6 py-10">
        <p className="rounded-xl border border-border bg-surface px-4 py-3 text-xs text-muted-foreground">
          <strong className="text-foreground">Disclosure:</strong> ReelRipper produces AI-generated videos featuring synthetic avatars — not real endorsers. When you publish a ReelRipper video that promotes a product for commission, you must disclose the paid relationship (e.g. <code>#ad</code>) and toggle each platform's AI-content label. See our <Link to="/affiliate-disclosure" className="underline hover:text-foreground">Affiliate Disclosure</Link>.
        </p>
